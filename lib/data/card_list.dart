...
List<GameCard> cardListOnHand = [
  ...
  GameCard(id: 4, name: "Рождение фотографии", year: 1839, category: Category.inventions, century: Century.earlier),
  GameCard(id: 4, name: "Патент на телефон", year: 1876, category: Category.inventions, century: Century.earlier),
  GameCard(id: 4, name: "Лампа накаливания", year: 1879, category: Category.inventions, century: Century.earlier),
